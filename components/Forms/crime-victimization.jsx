      ...
      {wasVictim && (
        <>
          ...
          <fieldset className="mt-3 border rounded p-3">
            <legend className="font-semibold">If yes, what crime/s were you victim of? (Check all that apply)</legend>
          ...
          {reportedCrime === false && (
            <fieldset className="mt-3 border rounded p-3">
              <legend className="font-semibold">If no, state the reason (check all that apply):</legend>

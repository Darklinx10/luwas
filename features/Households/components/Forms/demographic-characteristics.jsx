  ...
  useEffect(() => {
    const loadExistingMembers = async () => {
      ...
      try {
        ...
        const loadedMembers = membersSnap.docs.map(memberDoc => {
          const memberData = memberDoc.data();
          // Load demographic characteristics if available
          return {
            id: memberDoc.id,
            ...
            relationshipToHead: memberData.relationshipToHead || '',
            nuclearRelation: memberData.nuclearRelation || '',
            birthdate: memberData.birthdate || '',
            sex: memberData.sex || '',
            age: memberData.age || '',
            nuclearBelonging: memberData.nuclearBelonging || '',
            birthRegistered: memberData.birthRegistered || '',
            maritalStatus: memberData.maritalStatus || '',
            ethnicity: memberData.ethnicity || '',
            religion: memberData.religion || '',
            hasNationalID: memberData.hasNationalID || '',
            philsysNumber: memberData.philsysNumber || '',
            hasBiometric: memberData.hasBiometric || '',
            hasLGUID: memberData.hasLGUID || '',
            lguIdNumber: memberData.lguIdNumber || '',
            soloParent: memberData.soloParent || '',
            soloParentId: memberData.soloParentId || '',
            seniorCitizenId: memberData.seniorCitizenId || '',
            contactNumber: memberData.contactNumber || '',
            difficulties: memberData.difficulties || {},
          };
        });
